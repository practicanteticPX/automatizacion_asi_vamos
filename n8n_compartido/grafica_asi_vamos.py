...
# ── Datos (en producción son inyectados por n8n) ──────
nombre_cliente = "ALIMENTOS SAS S.A.S"
ventas_2024    =  50613144.51
ventas_2025    =  31497097.72
ventas_2026    =   4874288.00
...
# En prueba local: guardar también como archivo
with open('/output/grafica_asi_vamos.png', 'wb') as f:
    buf.seek(0)
    f.write(buf.read())
